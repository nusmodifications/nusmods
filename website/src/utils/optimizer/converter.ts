...
export class OptimizerInputSmtlibConverter {
  ...
  generateFreeDaySlotconstraints(): Array<SlotConstraint> {
    ...
    // Free Saturday is too easy, remove it (TODO: this creates a subtle bug if DAYS is not exactly 6!)
    // We won't count the last day of the week for free day calculations then
   ...
   * This method doesn't care about the times generated by other methods - it just blindly generates the constraints
   * */
  generateTimeconstraintSlotconstraint(): SlotConstraint | undefined {
    ...
    // Not even constraining any of the day, ignore (this is an additional optimization to avoid extra clauses)
