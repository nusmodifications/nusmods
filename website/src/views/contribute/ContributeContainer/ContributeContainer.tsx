...
const ContributeContainer = memo<Props>(({ modules, beta, ...props }) => (
  <div className={styles.pageContainer}>
    ...
    {currentTests.length > 0 && (
      <section>
        ...
        <p>
          ...
          feedback to shape the future of NUSMods. Currently we are testing the following features:
        </p>
    ...
    <section>
      ...
      <p>
        We are always open to feedback. If you see something that doesn&apos;t seem quite right, or
        have a new idea for making NUSMods better, you can use these links below to reach us.
      </p>
    ...
    <section>
      ...
      <p>
        NUSMods servers are currently graciously paid for by the school, but we still need money to
    ...
    <section>
      ...
      <p>
        You can also help directly contribute code and design. We welcome all contributions, big and
        small. To get your feet wet, we suggest starting with the good first issues suitable for
        first time contributors of various skill levels. We think NUSMods is a good way to learn
        modern web development on a production web application and make a positive impact on the
        lives of NUS students.
      </p>
      ...
      <p>
        Here are our top NUSMods contributors. Previous maintainers have gone on to work at Google,
        Facebook, and other prestigious technology companies. <strong>You</strong> could be next!
      </p>
