    ...
    <div className={styles.descriptionSection}>
        ...
        body={
          <>
            ...
            <p className={styles.bodyText}>
              You can indicate your preferences in the form above, and hit <i>Optimise Timetable</i>{' '}
              to generate an optimised timetable. When you click the <i>Open Optimised Timetable</i>{' '}
              button, it will bring you to a new page with the optimised timetable. If the timetable
              looks good to you, click <i>Import</i> to update your timetable.
            </p>
          </>
        }
      />
      <FAQComponent
        ...
        body={
          <>
            <p className={styles.lede}>
              While the optimiser will try to generate a timetable that matches your preferences as
              closely as possible, there are certain preferences that may be harder to meet (due to
              course schedules and conflicts).
            </p>
            <p className={styles.bodyText}>
      ...
      <FAQComponent
        ...
        body={
          <>
            ...
            <p className={styles.bodyText}>
              However, it will only generate a <i>partial</i> timetable. You may have to edit the timetable 
