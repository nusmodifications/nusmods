...
describe('OptimiserPinnedSlotSelect', () => {
  ...
  it('should show a button per lesson labelled with the module code and class', () => {
    ...
    expect(
      screen.getByRole('button', { name: `${defaultLectureOption.moduleCode} LEC [1]` }),
    ).toBeEnabled();
    expect(
      screen.getByRole('button', {
        name: `${defaultTutorialOption.moduleCode} TUT [2]`,
      }),
    ).toBeEnabled();
  });
