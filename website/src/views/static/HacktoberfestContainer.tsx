...
const TeamContainer: React.FC = () => (
  <StaticPage title={title} className={styles.page}>
    ...
    <p>
      <ExternalLink href="https://hacktoberfest.digitalocean.com/">Hacktoberfest</ExternalLink> is a
      month long celebration of open source. Help contribute to NUSMods by opening pull requests in
      the month of October and November and get an exclusive NUSMods shirts from us, and if you
      submit five pull requests in October to any GitHub repository, you can also get a free T-shirt
      from GitHub and DigitalOcean!
    </p>
    ...
    <p>
      ...
      <ExternalLink href="https://telegram.me/nusmods">talk to us on Telegram</ExternalLink> or read{' '}
    ...
    <p className={styles.disclaimer}>
      ...
      available for top five NUS students for students with the most number of commits by the end of
      November. NUSMods is not affiliated with Hacktoberfest in any way. Official Hacktoberfest
