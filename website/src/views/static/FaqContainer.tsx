  ...
  <StaticPage title="FAQ">
    ...
    <Card asChild>
      <div className={styles.question} id="mistakes">
        ...
        <p>
          ...
          department or faculty. If the department or faculty for this course cannot be found on
          this list, please refer to CourseReg's contact list for{' '}
    ...
    <Card asChild>
      <div className={styles.question} id="about">
        ...
        <p>
          ...
          certainly does not make decisions regarding your curriculum, course availability and
          course timetable. If you have questions regarding your curriculum, course registration,
          Canvas, or anything unrelated to NUSMods, please either contact your faculty or just{' '}
    ...
    <Card asChild>
      <div className={styles.question} id="white-page">
        ...
        <p>
          Please update your browser or use another computer to access NUSMods. Although we
          recommend the latest version of Google Chrome, Firefox, Safari or Edge, we support the
          latest two versions of these browsers. Unfortunately, we cannot support more browsers or
          older versions due to our limited resources.
        </p>
        <p>
