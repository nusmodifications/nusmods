...
import GEQ1917_JSON from './GEQ1917.json';
...
export const GEQ1917: Module = { ...GEQ1917_JSON, timestamp: 1572843950000 };
...
const modules: Module[] = [ACC2002, BFS1001, CS1010S, CS3216, GES1021, GEQ1917, PC1222];
