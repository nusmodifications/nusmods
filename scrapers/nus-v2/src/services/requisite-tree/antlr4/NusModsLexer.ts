...
export class NusModsLexer extends Lexer {
  ...
  public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(
    NusModsLexer._LITERAL_NAMES,
    NusModsLexer._SYMBOLIC_NAMES,
    [],
  );
  ...
  public get ruleNames(): string[] {
    return NusModsLexer.ruleNames;
  }

  // @Override
  public get serializedATN(): string {
    return NusModsLexer._serializedATN;
  }

  // @Override
  public get channelNames(): string[] {
    return NusModsLexer.channelNames;
  }

  // @Override
  public get modeNames(): string[] {
    return NusModsLexer.modeNames;
  }
  ...
  public static readonly _serializedATN: string = Utils.join(
    [NusModsLexer._serializedATNSegment0, NusModsLexer._serializedATNSegment1],
    '',
  );
  public static __ATN: ATN;
  public static get _ATN(): ATN {
    if (!NusModsLexer.__ATN) {
      NusModsLexer.__ATN = new ATNDeserializer().deserialize(
        Utils.toCharArray(NusModsLexer._serializedATN),
      );
    }
