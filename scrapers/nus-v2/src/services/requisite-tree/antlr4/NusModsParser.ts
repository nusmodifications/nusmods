...
export class NusModsParser extends Parser {
  ...
  public static readonly RULE_cohort_conditional = 4;
  public static readonly RULE_subject_years_conditional = 5;
  public static readonly RULE_binop = 6;
  public static readonly RULE_boolean_expr = 7;
  public static readonly RULE_op = 8;
  public static readonly RULE_primitive = 9;
  public static readonly RULE_programs = 10;
  public static readonly RULE_programs_condition = 11;
  public static readonly RULE_programs_values = 12;
  public static readonly RULE_plan_types = 13;
  public static readonly RULE_plan_types_condition = 14;
  public static readonly RULE_cohort_years = 15;
  public static readonly RULE_subject_years = 16;
  public static readonly RULE_special = 17;
  public static readonly RULE_special_condition = 18;
  public static readonly RULE_prereq = 19;
  public static readonly RULE_coreq = 20;
  public static readonly RULE_courses = 21;
  public static readonly RULE_course_items = 22;
  public static readonly RULE_must_be_in = 23;
  public static readonly RULE_must_not_be_in = 24;
  public static readonly RULE_if_in = 25;
  public static readonly RULE_if_not_in = 26;
  public static readonly RULE_contains_number = 27;
  ...
  public cohort_conditional(): Cohort_conditionalContext {
    ...
    this.enterRule(_localctx, 8, NusModsParser.RULE_cohort_conditional);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 91;
  ...
  public subject_years_conditional(): Subject_years_conditionalContext {
    ...
    this.enterRule(_localctx, 10, NusModsParser.RULE_subject_years_conditional);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 95;
  ...
  public binop(): BinopContext {
    ...
    this.enterRule(_localctx, 12, NusModsParser.RULE_binop);
    try {
      this.state = 104;
      this._errHandler.sync(this);
  ...
  public boolean_expr(): Boolean_exprContext {
    ...
    this.enterRule(_localctx, 14, NusModsParser.RULE_boolean_expr);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public op(): OpContext {
    ...
    this.enterRule(_localctx, 16, NusModsParser.RULE_op);
    try {
      this.state = 113;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
  ...
  public primitive(): PrimitiveContext {
    ...
    this.enterRule(_localctx, 18, NusModsParser.RULE_primitive);
    try {
      this.state = 124;
      this._errHandler.sync(this);
  ...
  public programs(): ProgramsContext {
    ...
    this.enterRule(_localctx, 20, NusModsParser.RULE_programs);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public programs_condition(): Programs_conditionContext {
    ...
    this.enterRule(_localctx, 22, NusModsParser.RULE_programs_condition);
    try {
      this.state = 137;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
  ...
  public programs_values(): Programs_valuesContext {
    ...
    this.enterRule(_localctx, 24, NusModsParser.RULE_programs_values);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public plan_types(): Plan_typesContext {
    ...
    this.enterRule(_localctx, 26, NusModsParser.RULE_plan_types);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public plan_types_condition(): Plan_types_conditionContext {
    ...
    this.enterRule(_localctx, 28, NusModsParser.RULE_plan_types_condition);
    try {
      this.state = 158;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
  ...
  public cohort_years(): Cohort_yearsContext {
    ...
    this.enterRule(_localctx, 30, NusModsParser.RULE_cohort_years);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public subject_years(): Subject_yearsContext {
    ...
    this.enterRule(_localctx, 32, NusModsParser.RULE_subject_years);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public special(): SpecialContext {
    ...
    this.enterRule(_localctx, 34, NusModsParser.RULE_special);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 177;
  ...
  public special_condition(): Special_conditionContext {
    ...
    this.enterRule(_localctx, 36, NusModsParser.RULE_special_condition);
    try {
      this.state = 187;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
  ...
  public prereq(): PrereqContext {
    ...
    this.enterRule(_localctx, 38, NusModsParser.RULE_prereq);
    let _la: number;
    try {
      this.state = 200;
      this._errHandler.sync(this);
  ...
  public coreq(): CoreqContext {
    ...
    this.enterRule(_localctx, 40, NusModsParser.RULE_coreq);
    try {
      this.state = 210;
      this._errHandler.sync(this);
  ...
  public courses(): CoursesContext {
    ...
    this.enterRule(_localctx, 42, NusModsParser.RULE_courses);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public course_items(): Course_itemsContext {
    ...
    this.enterRule(_localctx, 44, NusModsParser.RULE_course_items);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public must_be_in(): Must_be_inContext {
    ...
    this.enterRule(_localctx, 46, NusModsParser.RULE_must_be_in);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public must_not_be_in(): Must_not_be_inContext {
    ...
    this.enterRule(_localctx, 48, NusModsParser.RULE_must_not_be_in);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public if_in(): If_inContext {
    ...
    this.enterRule(_localctx, 50, NusModsParser.RULE_if_in);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 234;
  ...
  public if_not_in(): If_not_inContext {
    ...
    this.enterRule(_localctx, 52, NusModsParser.RULE_if_not_in);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 236;
  ...
  public contains_number(): Contains_numberContext {
    ...
    this.enterRule(_localctx, 54, NusModsParser.RULE_contains_number);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 238;
  ...
  public static readonly _serializedATN: string =
    '\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03\x1E\xF5\x04\x02' +
    '\t\x02\x04\x03\t\x03\x04\x04\t\x04\x04\x05\t\x05\x04\x06\t\x06\x04\x07' +
    '\t\x07\x04\b\t\b\x04\t\t\t\x04\n\t\n\x04\v\t\v\x04\f\t\f\x04\r\t\r\x04' +
    '\x0E\t\x0E\x04\x0F\t\x0F\x04\x10\t\x10\x04\x11\t\x11\x04\x12\t\x12\x04' +
    '\x13\t\x13\x04\x14\t\x14\x04\x15\t\x15\x04\x16\t\x16\x04\x17\t\x17\x04' +
    '\x18\t\x18\x04\x19\t\x19\x04\x1A\t\x1A\x04\x1B\t\x1B\x04\x1C\t\x1C\x04' +
    '\x1D\t\x1D\x03\x02\x03\x02\x03\x02\x03\x02\x05\x02?\n\x02\x03\x03\x03' +
    '\x03\x03\x03\x05\x03D\n\x03\x03\x03\x03\x03\x03\x03\x07\x03I\n\x03\f\x03' +
    '\x0E\x03L\v\x03\x03\x04\x03\x04\x03\x04\x03\x04\x03\x04\x03\x04\x03\x04' +
    ...
    '\v\x05\v\x7F\n\v\x03\f\x03\f\x03\f\x03\f\x03\f\x05\f\x86\n\f\x03\r\x03' +
    '\r\x03\r\x03\r\x05\r\x8C\n\r\x03\x0E\x03\x0E\x03\x0E\x07\x0E\x91\n\x0E' +
    '\f\x0E\x0E\x0E\x94\v\x0E\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x05\x0F' +
    '\x9B\n\x0F\x03\x10\x03\x10\x03\x10\x03\x10\x05\x10\xA1\n\x10\x03\x11\x03' +
    '\x11\x03\x11\x03\x11\x03\x11\x05\x11\xA8\n\x11\x03\x11\x03\x11\x05\x11' +
    '\xAC\n\x11\x03\x12\x03\x12\x03\x12\x03\x12\x05\x12\xB2\n\x12\x03\x13\x03' +
    '\x13\x03\x13\x03\x13\x03\x13\x03\x13\x03\x14\x03\x14\x03\x14\x03\x14\x05' +
    '\x14\xBE\n\x14\x03\x15\x03\x15\x03\x15\x03\x15\x05\x15\xC4\n\x15\x03\x15' +
    '\x03\x15\x03\x15\x03\x15\x03\x15\x05\x15\xCB\n\x15\x03\x16\x03\x16\x03' +
    '\x16\x03\x16\x03\x16\x03\x16\x03\x16\x03\x16\x05\x16\xD5\n\x16\x03\x17' +
    '\x03\x17\x05\x17\xD9\n\x17\x03\x17\x03\x17\x03\x18\x03\x18\x03\x18\x07' +
    '\x18\xE0\n\x18\f\x18\x0E\x18\xE3\v\x18\x03\x19\x03\x19\x05\x19\xE7\n\x19' +
    '\x03\x1A\x03\x1A\x05\x1A\xEB\n\x1A\x03\x1B\x03\x1B\x03\x1C\x03\x1C\x03' +
    '\x1D\x03\x1D\x03\x1D\x03\x1D\x03\x1D\x02\x02\x02\x1E\x02\x02\x04\x02\x06' +
    '\x02\b\x02\n\x02\f\x02\x0E\x02\x10\x02\x12\x02\x14\x02\x16\x02\x18\x02' +
    '\x1A\x02\x1C\x02\x1E\x02 \x02"\x02$\x02&\x02(\x02*\x02,\x02.\x020\
    '\x02\x02\x02\xB9\xBE\x054\x1B\x02\xBA\xBE\x056\x1C\x02\xBB\xBE\x050\x19' +
    '\x02\xBC\xBE\x052\x1A\x02\xBD\xB9\x03\x02\x02\x02\xBD\xBA\x03\x02\x02' +
    "\x02\xBD\xBB\x03\x02\x02\x02\xBD\xBC\x03\x02\x02\x02\xBE\'\x03\x02\x02" +
    '\x02\xBF\xCB\x03\x02\x02\x02\xC0\xCB\x05,\x17\x02\xC1\xC3\x07\x16\x02' +
    '\x02\xC2\xC4\x058\x1D\x02\xC3\xC2\x03\x02\x02\x02\xC3\xC4\x03\x02\x02' +
    '\x02\xC4\xC5\x03\x02\x02\x02\xC5\xCB\x05\x1A\x0E\x02\xC6\xC7\x07\x17\x02' +
    '\x02\xC7\xCB\x058\x1D\x02\xC8\xC9\x07\x18\x02\x02\xC9\xCB\x058\x1D\x02' +
    '\xCA\xBF\x03\x02\x02\x02\xCA\xC0\x03\x02\x02\x02\xCA\xC1\x03\x02\x02\x02' +
    '\xCA\xC6\x03\x02\x02\x02\xCA\xC8\x03\x02\x02\x02\xCB)\x03\x02\x02\x02' +
    '\xCC\xD5\x03\x02\x02\x02\xCD\xCE\x07\x19\x02\x02\xCE\xCF\x07\x04\x02\x02' +
    '\xCF\xD0\x05,\x17\x02\xD0\xD1\x07\x05\x02\x02\xD1\xD5\x03\x02\x02\x02' +
    '\xD2\xD3\x07\x19\x02\x02\xD3\xD5\x05,\x17\x02\xD4\xCC\x03\x02\x02\x02' +
    '\xD4\xCD\x03\x02\x02\x02\xD4\xD2\x03\x02\x02\x02\xD5+\x03\x02\x02\x02' +
    '\xD6\xD8\x07\x15\x02\x02\xD7\xD9\x058\x1D\x02\xD8\xD7\x03\x02\x02\x02' +
    '\xD8\xD9\x03\x02\x02\x02\xD9\xDA\x03\x02\x02\x02\xDA\xDB\x05.\x18\x02' +
    '\xDB-\x03\x02\x02\x02\xDC\xE1\x07\x1D\x02\x02\xDD\xDE\x07\x03\x02\x02' +
    '\xDE\xE0\x07\x1D\x02\x02\xDF\xDD\x03\x02\x02\x02\xE0\xE3\x03\x02\x02\x02' +
    '\xE1\xDF\x03\x02\x02\x02\xE1\xE2\x03\x02\x02\x02\xE2/\x03\x02\x02\x02' +
    '\xE3\xE1\x03\x02\x02\x02\xE4\xE6\x07\x07\x02\x02\xE5\xE7\x058\x1D\x02' +
    '\xE6\xE5\x03\x02\x02\x02\xE6\xE7\x03\x02\x02\x02\xE71\x03\x02\x02\x02' +
    '\xE8\xEA\x07\t\x02\x02\xE9\xEB\x058\x1D\x02\xEA\xE9\x03\x02\x02\x02\xEA' +
    '\xEB\x03\x02\x02\x02\xEB3\x03\x02\x02\x02\xEC\xED\x07\x06\x02\x02\xED' +
    '5\x03\x02\x02\x02\xEE\xEF\x07\b\x02\x02\xEF7\x03\x02\x02\x02\xF0\xF1\x07' +
    '\x04\x02\x02\xF1\xF2\x07\x1B\x02\x02\xF2\xF3\x07\x05\x02\x02\xF39\x03' +
    '\x02\x02\x02\x19>CJWjs~\x85\x8B\x92\x9A\xA0\xA7\xAB\xB1\xBD\xC3\xCA\xD4' +
    '\xD8\xE1\xE6\xEA';
...
export class Program_types_conditionalContext extends ParserRuleContext {
  public program_types(): Program_typesContext {
    return this.getRuleContext(0, Program_typesContext);
  }
