...
export class NusModsParser extends Parser {
	...
	public static readonly _serializedATN: string =
		...
		"RS\x05\x06\x04\x02ST\x07\x05\x02\x02TW\x03\x02\x02\x02UW\x05\x0E\b\x02" +
		"VQ\x03\x02\x02\x02VU\x03\x02\x02\x02W\r\x03\x02\x02\x02Xa\x03\x02\x02" +
		"\x02Ya\x05\x10\t\x02Za\x05\x16\f\x02[a\x05\x1A\x0E\x02\\a\x05\x1C\x0F" +
		"\x02]a\x05\x1E\x10\x02^a\x05\"\x12\x02_a\x05$\x13\x02`X\x03\x02\x02\x02" +
		"`Y\x03\x02\x02\x02`Z\x03\x02\x02\x02`[\x03\x02\x02\x02`\\\x03\x02\x02" +
		"\x02`]\x03\x02\x02\x02`^\x03\x02\x02\x02`_\x03\x02\x02\x02a\x0F\x03\x02" +
		"\x02\x02bc\x07\x0F\x02\x02cd\x05\x12\n\x02de\x05\x14\v\x02e\x11\x03\x02" +
		"\x02\x02fk\x07\x06\x02\x02gk\x07\b\x02\x02hk\x05*\x16\x02ik\x05,\x17\x02" +
