// flow-typed signature: eab60687de66c63c726305deb8e41ad4
// flow-typed version: <<STUB>>/react-waypoint_v7.0.4/flow_v0.54.0
...
declare module 'react-waypoint' {
  ...
  declare export default ComponentType<WaypointProps> & {
    +above: string;
    +below: string;
    +inside: string;
    +invisible: string;
