...
describe(ADD_PLANNER_MODULE, () => {
  ...
  test('should not add duplicate modules', () => {
    expect(reducer(initial, addPlannerModule('CS1010S', '2018/2019', 1)).modules).toEqual({
      CS1010S: ['2018/2019', 1],
    });
...
describe(MOVE_PLANNER_MODULE, () => {
  ...
  test('should move module to other acad year or semester', () => {
    expect(reducer(initial, movePlannerModule('CS1010S', '2018/2019', 2)).modules).toEqual({
      CS1010S: ['2018/2019', 2],
    });

    expect(reducer(initial, movePlannerModule('CS1010S', '2017/2018', 2)).modules).toEqual({
      CS1010S: ['2017/2018', 2],
    });
  });
});
