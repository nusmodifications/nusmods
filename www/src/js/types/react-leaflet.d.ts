...
declare module 'react-leaflet' {
  ...
  export namespace LayersControl {
    ...
    class BaseLayer<P extends ControlledLayerProps = ControlledLayerProps> extends ControlledLayer<
      P
    > {}
    class Overlay<P extends ControlledLayerProps = ControlledLayerProps> extends ControlledLayer<
      P
    > {}
  }
