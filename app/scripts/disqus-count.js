...
typeof DISQUSWIDGETS == "undefined" && (DISQUSWIDGETS = function() {
    var c = {}, n = document.getElementsByTagName("HEAD")[0] || document.body, i = {}, m = {identifier: 1,url: 2};
    c.domain = "disqus.com";
    c.forum = "";
    c.getCount = function() {
        i = {};
        ...
        var o = document.location.protocol + "//" + c.forum + "." + c.domain + "/count-data.js?", d = [], g = 0, j = 10;
        ...
        for (a = d.slice(g, j); a.length; )
            b = document.createElement("script"), b.async = !0, b.src = o + a.join("&"), n.appendChild(b), g += 10, j += 10, a = d.slice(g, j)
    };
