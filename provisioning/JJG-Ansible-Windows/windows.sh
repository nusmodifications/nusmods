...
if [ ! -f "/home/vagrant/NUSMods/$ANSIBLE_PLAYBOOK" ]; then
...
find "/home/vagrant/NUSMods/$PLAYBOOK_DIR" \( -name "requirements.yml" -o -name "requirements.txt" \) -exec sudo ansible-galaxy install -r {} \;

grep -q -F "alias npm='npm --no-bin-links'" /home/vagrant/.bashrc || echo "alias npm='npm --no-bin-links'" >> /home/vagrant/.bashrc
